...
const TopBeautyParlour = () => {
  const navigate = useNavigate();
  const [topBeautyParlour, setTopBeautyParlour] = useState([
  ...
  return (
    <div>
      <h2>Top Beauty Parlour</h2>

      <div className="artist-cards">
        {topBeautyParlour.map((artist) => (
...
export default TopBeautyParlour;